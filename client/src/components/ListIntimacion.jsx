...
export function ListIntimacion() { 
...
// } 
function op_Home(){   
  document.getElementById("caja_Intimacion").style.display = "none"; 
  document.getElementById("caja_menu").style.display = "initial";              
  // setHome("1");        
}
...
return (
        ...
        <>
            <div id="caja_Intimacion" style={{textAlign:"center"}}>
